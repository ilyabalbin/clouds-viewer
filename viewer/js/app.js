...
const updateRasterTile = () => {
    ...
    let tileURL = `${landsat_tiler_url}/landsat/tiles/${meta.sceneid}/{z}/{x}/{y}.png?` +
        `rgb=${rgb}` +
        '&tile=256';
    
    if (!((rgb=='12,12,12') || (rgb=='13,13,13')|| (rgb=='14,14,14')|| (rgb=='15,15,15'))){
        tileURL = tileURL + `&histo=${meta.rgbMinMax[bands[0]]}-${meta.rgbMinMax[bands[1]]}-${meta.rgbMinMax[bands[2]]}`;
    }
